...
// 飞客茶馆优惠信息
router.get('/flyert/preferential', require('./routes/flyert/preferential'));
router.get('/flyert/creditcard/:bank', require('./routes/flyert/creditcard'));
router.get('/flyertea/preferential', require('./routes/flyert/preferential'));
router.get('/flyertea/creditcard/:bank', require('./routes/flyert/creditcard'));
